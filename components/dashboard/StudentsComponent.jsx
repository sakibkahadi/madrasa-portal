...
const studentsCards = [
  ...
  { name: "studentsAttendance", banglaName: "শিক্ষার্থীদের ", icon: FileText, gradient: "bg-gradient-to-r from-yellow-500 to-amber-500", slug: "students-attendance" },
  { name: "studentsLeave", banglaName: "শিক্ষার্থীদের ", icon: Book, gradient: "bg-gradient-to-r from-purple-500 to-amber-500", slug: "students-leave" },
];
